...
const filteredProducts = computed(() => {
    ...
    return props.products.filter((p) => p.category_id === activeCategory.value);
});
</script>
            ...
            <div class="grid grid-cols-2 gap-6 px-4">
                ...
                >
                    <div class="h-40 bg-gray-100 overflow-hidden">
                        ...
                        <div
                            v-else
                            class="h-full flex items-center justify-center bg-gradient-to-br from-pink-200 to-purple-200 text-5xl"
                        >
                            📦
                        </div>
                    </div>
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex justify-between items-center mt-3">
                            ...
                            <button
                                class="px-4 py-2 rounded-full bg-gradient-to-r from-pink-400 to-teal-400 text-white text-sm"
                            >
                                Buy
                            </button>
                        </div>
